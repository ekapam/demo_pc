...
<?php foreach($list as $num_row => $row) : ?>
    <tr>
        <td<?php if ($unset_delete) : ?> style="border-right: none;"<?php endif; ?><?php if ($buttons_counter === 0) : ?> class="hidden"<?php endif; ?>>
<?php if (!$unset_delete) : ?>
            <input type="checkbox" class="select-row" data-id="<?php echo $row->primary_key_value; ?>" />
<?php endif; ?>
        </td>
        <td<?php if ($unset_delete) : ?> style="border-left: none;"<?php endif; ?><?php if ($buttons_counter === 0) : ?> class="hidden"<?php endif; ?>>
...
<?php if ($show_more_button) : ?>
                <div class="btn-group dropdown">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><?php echo $more_string; ?> <span class="caret"></span></button>
...
<?php $action = $actions[$action_unique_id]; ?>
...
<?php endif; ?>
        ...
        <?php foreach($columns as $column) { ?>
            <td>
                <a href="<?php echo $row->edit_url?>" target="_parent">
