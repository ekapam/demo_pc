...
<?php if(!$unset_export) : ?>
								<a class="btn btn-default t5 gc-export" data-url="<?php echo $export_url; ?>">
									...
									<span class="hidden-xs floatL l5"><?php echo $this->l('list_export');?></span>
									<div class="clear"></div>
								</a>
<?php endif; ?>
<?php if(!$unset_print) : ?>
								<a class="btn btn-default t5 gc-print" data-url="<?php echo $print_url; ?>">
									...
									<span class="hidden-xs floatL l5"><?php echo $this->l('list_print');?></span>
									<div class="clear"></div>
								</a>
<?php endif; ?>
...
<?php endforeach;?>
								...
								<tr class="filter-row gc-search-row">
									<td class="no-border-right <?php if ($buttons_counter === 0) : ?>hidden<?php endif; ?>">
<?php if (!$unset_delete) : ?>
										 <div class="floatL t5">
...
<?php endif; ?>
									...
									<td class="no-border-left <?php if ($buttons_counter === 0) : ?>hidden<?php endif; ?>">
										<div class="floatL">
...
<?php include(__DIR__."/list_tbody.php"); ?>
							...
							<div class="footer-tools">
								...
								<div class="floatL t20 l5">
									<div class="floatL t10"><?php list($show_lang_string, $entries_lang_string) = explode('{paging}', $this->l('list_show_entries')); ?><?php echo $show_lang_string; ?></div>
									<div class="floatL r5 l5 t3">
										<select name="per_page" class="per_page form-control">
<?php foreach($paging_options as $option) : ?>
											<option value="<?php echo $option; ?>"<?php if($option == $default_per_page) : ?> selected="selected"<?php endif; ?>><?php echo $option; ?>&nbsp;&nbsp;</option>
<?php endforeach; ?>
										</select>
									</div>
									<div class="floatL t10"><?php echo $entries_lang_string; ?></div>
									<div class="clear"></div>
								</div>
