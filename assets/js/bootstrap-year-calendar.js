 ...
 * ========================================================= */
 ...
 (function($) {
		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
					...
					monthContainerClass += ' col-xs-5';
				}
				else if(monthSize * 3 < calendarSize) {
					monthContainerClass += ' col-xs-7';
				}
				else if(monthSize * 2 < calendarSize) {
					monthContainerClass += ' col-xs-10';
				}
				else {
					monthContainerClass += ' col-xs-20';
				}
	...
	var colors = $.fn.calendar.colors = ['#006495', '#18A245', '#F68428'];
