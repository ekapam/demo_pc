...
<head>
	...
	<title>Notificación de Registro de Gestor</title>
</head>
<body>
	<div>
		<div>
		...
		<h1 style="margin-top: 0; color: #444; font-family: sans-serif; margin-bottom: 25px">Notificación de Registro de Gestor</h1>
