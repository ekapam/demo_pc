                    ...
                    <div id="menu-cabeza" class="container">
                        ...
                        <div class="navbar-collapse collapse navbar-right">
                            ...
                            <ul class="nav navbar-nav">
                                <li class="visible-xs-block"><a href="javascript:;"><i class="glyphicon glyphicon-user"></i> <?php $nombre = $_SESSION['cnd_first_name']." ".$_SESSION['cnd_last_name']; echo $nombre; ?></a></li>
