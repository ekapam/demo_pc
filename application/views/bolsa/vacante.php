            ...
            <div class="col-lg-20">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-7">
                        <div id="sidebar-datos" class="well">
                            ...
                            <div class="datos"><?php echo $vacante->vcnt_experiencia; ?> o mas.</div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="encabezado">Número de vacantes:</div>
                            <div class="datos"><?php echo $vacante->vcnt_cantidad; ?> vacantes.</div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="encabezado">Nivel de estudios requerido:</div>
                            <div class="datos"><?php echo $vacante->vcnt_educacion; ?> o superior.</div>
