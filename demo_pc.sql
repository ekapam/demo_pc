...
`std_id` int(11) NOT NULL,
  ...
  `std_nombre` varchar(45) NOT NULL,
...
(1, 'ekapam@gmail.com', 'Ricardo', 'Ambriz', 'sha256:1000:/68nZJeC+YbdNMIsZpnz+wqxGNKdONph:wofE86xjStlO84d7s9SwKPs3gwsoK6yM', '2016-09-09 08:15:03', 'confirmado');
...
INSERT INTO `vacantes_att` (`att_id`, `att_name`, `att_value`, `att_status`) VALUES
(1, 'categoria', 'Administración / Oficina', 0),
(2, 'categoria', 'Almacén / Logística / Transporte', 0),
(3, 'contratacion', 'Medio Tiempo', 0);
...
ALTER TABLE `municipios`
 ADD PRIMARY KEY (`mncps_id`), ADD KEY `mncps_std_id` (`mncps_std_id`);
...
ALTER TABLE `vacantes_att`
 ADD PRIMARY KEY (`att_id`), ADD KEY `att_name` (`att_name`);


ALTER TABLE `candidatos`
MODIFY `cnd_id` int(10) NOT NULL AUTO_INCREMENT;
ALTER TABLE `estados`
...
ALTER TABLE `tokens`
MODIFY `tkn_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
ALTER TABLE `vacantes`
MODIFY `vcnt_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
ALTER TABLE `vacantes_att`
MODIFY `att_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
